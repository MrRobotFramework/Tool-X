...
def ressture():
   ...
   import getpass
   sandi = raw_input('║PW      : ')
   if sandi == 'MrRobot Framework' and user == 'subscribe':
      print '║LOGIN SUKSES\n╚═══════\x1b[1;91m▶'
      sys.exit
   else:
...
def lodhirt():
    lodhirt = [
     'MrRobot', '      ', 'MrRobot', '      ', 'MrRobot', '      ', 'MrRobot', '      ', 'MrRobot', '      ', 'MrRobot', '      ', 'MrRobot', '      ', 'MrRobot', '      ', 'MrRobot', '      ', 'MrRobot', 'MrRobot', '      ', 'MrRobot', '      ', 'MrRobot', '      ', 'MrRobot', '      ', 'MrRobot', '      ', 'MrRobot', '      ', 'MrRobot', '      ', 'MrRobot', '      ', 'MrRobot', '      ', 'MrRobot\n']
    for o in lodhirt:
...
print '║\033[1;37m{\033[1;33m2\033[1;37m} \033[1;34mHubungi Author \033[0m(\033[1;32mTelegram\033[1;37m)'
...
if pilih == 1:
	...
	os.system('xdg-open https://duit.cc/U9Ab6')
elif pilih == 0:
	os.system('clear')
